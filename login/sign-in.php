          ...
          <div class="row">
              ...
              <div class="card card-plain mt-8">
                ...
                <?php
                  ...
                  if($cek > 0 ){
                    ...
                    echo '<script>alert("login berhasil"); location.href="../index.php?page=pages/dashboard";</script>';
                  }else{
            ...
            <div class="col-md-6">
              <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8">
                <div class="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6" style="background-image:url('../assets/images/digital_library2.jpg')"></div>
              </div>
            </div>
          </div>
        </div>
