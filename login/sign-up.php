...
<body class="">
  ...
  <main class="main-content  mt-0">
    <section class="min-vh-100 mb-8">
      <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg" style="background-image: url('../assets/images/digital_library2.jpg');">
          ...
          <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
            <div class="card z-index-0">
              ...
              <?php
                  ...
                  $insert = mysqli_query($koneksi, "INSERT INTO user(namalengkap,email,alamat,username,password,level) VALUES('$nama','$email','$alamat','$username','$password','$level')");
              ...
              <div class="card-body">
                <form role="form text-left" method="post">
                  <div class="mb-3">
                    <input type="text" name="namalengkap" class="form-control" placeholder="Nama Lengkap" aria-label="Name" aria-describedby="email-addon">
                  </div>
                  <div class="mb-3">
